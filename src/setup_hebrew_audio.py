...
script = os.path.join(os.path.dirname(__file__),"spelling_app_hebrew_audio.py")
output_path = "C:\\Users\\ylevitt\\Downloads\\Funetics"
...
setup(
    ...
    options={
        "build_exe": {
                "include_files" : [("Spelling_Words","Spelling_Words")],
                "includes" : includes,
                "excludes":  excludes,
                "packages" : packages,
                "include_msvcr": True,
